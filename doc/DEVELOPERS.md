...
```bash
pnpm test                                  # everything headless, 235 tests
pnpm --filter @rackutils/adg-codec test    # 182 codec tests
pnpm --filter @rackutils/editor-ui test    # 53 UI tests
pnpm test:e2e                              # 47 browser specs, needs Chromium
```
